...
/**
 * 灭菌参数达标阈值判据对象 t_cssd_param_rule
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_cssd_param_rule")
@ApiModel(value = "TCssdParamRule", description = "灭菌参数达标阈值判据")
public class TCssdParamRule implements Serializable {
    ...
    /** 合格档上限 */
    @TableField("th1_max")
    @ApiModelProperty(value = "合格档上限")
    private BigDecimal th1Max;

    /** 关注档上限 */
    @TableField("th2_max")
    @ApiModelProperty(value = "关注档上限")
    private BigDecimal th2Max;

    /** 警戒档上限 */
    @TableField("th3_max")
    @ApiModelProperty(value = "警戒档上限")
    ...
    /** 先后次序(数值越大越优先) */
    @TableField("priority")
    @ApiModelProperty(value = "先后次序(数值越大越优先)")
