...
/**
 * 灭菌参数达标阈值判据 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITCssdParamRuleService {

    /** 按主键查询规则 */
    TCssdParamRule selectTCssdParamRuleById(Long id);
    ...
    List<TCssdParamRule> listAvailable(Date at);
